--Resource: 'Cayo Perico Loader/Unloader by Mahan'
...
CreateThread(function()
	while not Framework.PlayerData.coords do Wait(1000) end
	...
	local distance
	while true do
		distance = #(vec(Framework.PlayerData.coords.x, Framework.PlayerData.coords.y, Framework.PlayerData.coords.z) - islandCoords)
		...
		elseif distance > 2000.0 and islandLoaded then
				islandLoaded = false
